...
- [x] **Phase 2: BUD-15 CHK and Secret-Safe References** - Consumers can use exact deterministic CHK encryption safely in plaintext or encrypted workflows. (completed 2026-08-12)
...
- [x] 01-02-PLAN.md — Prove root isolation and packed-package resolution, then record the release change.
...
- [x] 02-02-PLAN.md — Add strict lossless capability references and plaintext-default secret-safe contracts.

**Wave 3** *(blocked on Waves 1–2 completion)*

- [x] 02-03-PLAN.md — Publish and verify the portable package surface, root isolation, documentation, and release intent.
...
| 2. BUD-15 CHK and Secret-Safe References | 3/3 | Complete    | 2026-08-12 |
